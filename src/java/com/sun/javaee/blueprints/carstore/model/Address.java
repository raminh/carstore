...
public class Address implements java.io.Serializable {
    ...
    public String[] validateWithMessage() {
        ...
        if(street1 == null || street1.equals("")) {
            valMess.add(CarstoreUtil.getMessage("invalid_address_street1"));
        }
        if(city == null || city.equals("")) {
            valMess.add(CarstoreUtil.getMessage("invalid_address_city"));
        }
        if(state == null || state.equals("")) {
            valMess.add(CarstoreUtil.getMessage("invalid_address_state"));
        }
        if(zip == null || zip.equals("")) {
            valMess.add(CarstoreUtil.getMessage("invalid_address_zip"));
        }
