...
package com.sun.javaee.blueprints.carstore.model;

import com.sun.javaee.blueprints.carstore.search.IndexDocument;
import com.sun.javaee.blueprints.carstore.search.Indexer;
import com.sun.javaee.blueprints.carstore.search.UpdateIndex;
...
public class CatalogFacade implements ServletContextListener {
    ...
    // 
    // carstore/src/java/com/sun/javaee/blueprints/carstore/model/CatalogFacade.java:240: warning: [unchecked] unchecked conversion
    // found   : java.util.List
    // required: java.util.List<com.sun.javaee.blueprints.carstore.model.Product>
    ...
    @PersistenceUnit(unitName="CarstorePu")
   ...
   public List<Category> getCategories(){
    ...
    public void updateItem(Item item){
        ...
        try{
            ...
            //UpdateIndex.deleteIndex(CarstoreConstants.CARSTORE_INDEX_DIRECTORY, item.getItemID());
            //indexItem(new IndexDocument(item));
        } catch(Exception exe){
            try {
                utx.rollback();
    ...
    public void addTagsToItemId(String sxTags, String itemId) {
        ...
        try {
            ...
            update.updateDocTag(CarstoreConstants.CARSTORE_INDEX_DIRECTORY, "tag", item.tagsAsString(), item.getItemID(), UpdateIndex.REPLACE_FIELD);
    ...
    private void indexItem(IndexDocument indexDoc) {
        ...
        try {
 //           indexer=new Indexer(CarstoreConstants.CARSTORE_INDEX_DIRECTORY, false);
   //         CarstoreUtil.getLogger().log(Level.FINE, "Adding document to index: " + indexDoc.toString());
           // indexer.addDocument(indexDoc);
        } catch (Exception e) {
            CarstoreUtil.getLogger().log(Level.WARNING, "index.exception", e);
            e.printStackTrace();
        } finally {
            try {
