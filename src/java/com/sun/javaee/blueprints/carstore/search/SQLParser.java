...
public class SQLParser {
    ...
    public void runSQL(String sxIndexFile, Connection conn, String sql, String tagSql) {
        CarstoreUtil.getLogger().log(Level.INFO, "index.sql.statement", sql);
        ...
        try {
            ...
            while(result.next()) {
                ...
                CarstoreUtil.getLogger().log(Level.INFO, "Adding document to index: " + indexDoc.toString());
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String sxJdbcURL="jdbc:derby://localhost:1527/carstore";
