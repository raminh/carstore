...
public class HTMLParser {
    ...
    public static void main(String[] args) {
        ...
        hp.runWeb("http://localhost:8080", "carstore", "main.screen");
        ...
        try {
            ...
            for (String sxURL : vtURLs) {
                ...
                try {
                    ...
                    CarstoreUtil.getLogger().log(Level.SEVERE, "Inner Exception" + ee);
                }
            }
        } catch (Exception e) {
            CarstoreUtil.getLogger().log(Level.SEVERE, "Outer Exception" + e);
        } finally {
            try {
                if (indexer != null) {
                    indexer.close();
    ...
    private List<String> getRobots(String beginURL, String contextRoot) {
        ...
        try {
            ...
            CarstoreUtil.getLogger().log(Level.SEVERE, "Exception" + e);
