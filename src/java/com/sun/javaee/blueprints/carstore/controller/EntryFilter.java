...
public class EntryFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            if(!httpRequest.isRequestedSessionIdValid()) {
                ...
                CarstoreUtil.getLogger().log(Level.FINE,"Do not have Session, have page " + httpRequest.getPathInfo());
    ...
    private void sendProcessingError(Throwable t, ServletResponse response) {
        ...
        if(stackTrace != null && !stackTrace.equals("")) {
            ...
            try {
                ...
                pw.print(stackTrace);
                pw.print("</pre></body>\n</html>"); //NOI18N
                CarstoreUtil.closeIgnoringException(pw);
                CarstoreUtil.closeIgnoringException(ps);
                CarstoreUtil.closeIgnoringException(response.getOutputStream());
    ...
    public static String getStackTrace(Throwable t) {
        ...
        CarstoreUtil.closeIgnoringException(pw);
        CarstoreUtil.closeIgnoringException(sw);
