...
public class ImageAction implements ControllerAction {
    ...
    public void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException  {
        ...
        if(!imageFile.exists()) {
            ...
            imageFile=new File(CarstoreConstants.CARSTORE_IMAGE_DIRECTORY + pathInfo);
            //if(bDebug) System.out.println("Image alter path = " + CarstoreConstants.CARSTORE_IMAGE_DIRECTORY + pathInfo);
            if(!imageFile.exists()) {
                CarstoreUtil.getLogger().log(Level.SEVERE, "image_does_not_exist", CarstoreConstants.CARSTORE_IMAGE_DIRECTORY + pathInfo);
                return;
            }
        }
        ...
        try {
            ...
            CarstoreUtil.closeIgnoringException(in);
            CarstoreUtil.closeIgnoringException(fis);
            CarstoreUtil.closeIgnoringException(out);
        }
    }
}
