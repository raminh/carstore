...
import com.sun.javaee.blueprints.carstore.controller.actions.CaptchaAction;
import com.sun.javaee.blueprints.carstore.controller.actions.CatalogXmlAction;
import com.sun.javaee.blueprints.carstore.controller.actions.DefaultControllerAction;
import com.sun.javaee.blueprints.carstore.controller.actions.ImageAction;
import com.sun.javaee.blueprints.carstore.controller.actions.TagXmlAction;
...
public class ControllerServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (action != null) {
            ...
            CarstoreUtil.getLogger().log(Level.SEVERE, "Servlet '" + request.getServletPath() + "' not registered in ControllerServlet!!");
