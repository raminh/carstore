...
import com.sun.javaee.blueprints.carstore.controller.ControllerServlet;
...
public class DefaultControllerAction implements ControllerAction {
    ...
    // carstore/src/java/com/sun/javaee/blueprints/carstore/controller/actions/DefaultControllerAction.java:64: warning: [unchecked] unchecked cast
    ...
    public StringBuffer getResource(String resource, boolean fromWeb, boolean cacheContent) {
        try {
            ...
            CarstoreUtil.getLogger().log(Level.SEVERE, "ControllerServlet:loadResource error: Could not load", resource + " - " + e.toString());
        }
        return null;
    }
    ...
    private StringBuffer getResource(InputStream stream) {
        ...
        try {
            ...
            CarstoreUtil.getLogger().log(Level.SEVERE, "ControllerServlet:loadResource from stream error", e);
        }
        return buffer;
    }
}
