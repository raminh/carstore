...
package com.sun.javaee.blueprints.carstore.mapviewer;
...
public class MapBean {
    ...
    public String mapItems(FacesContext context, List<Item> items, GeoPoint[] geoCenterPoint, String centerx) {
        if(items != null && (items.size() > 0 || geoCenterPoint != null)) {
            ...
            CarstoreUtil.getLogger().log(Level.FINE, "ZOOM - Lat and long  - " + zoomLevel + " - " + dLat + " - " + dLong);
    ...
    public GeoPoint[] lookUpAddress(FacesContext context) {
        ...
        try {
            ...
            if ((points == null) || (points.length < 1)) {
                CarstoreUtil.getLogger().log(Level.INFO, "No addresses for location - " + centerx);
